...
const T = {
    ru: {
        ...
        'summary': 'Quick Expenses решает конкретную задачу — быстрый, приватный и понятный учёт личных расходов без навязанных подписок и облачных сервисов. Данные не покидают устройство. Импорт банковской выписки — секунды. Автокатегоризация — на устройстве. Без регистрации, без backend, без компромиссов.',
    ...
    en: {
        ...
        'summary': 'Quick Expenses solves a specific problem \u2014 fast, private, and intuitive personal expense tracking without forced subscriptions or cloud services. Data never leaves your device. Bank statement import \u2014 seconds. Auto-categorization \u2014 on-device. No registration, no backend, no compromise.',
